...
import styles from '../styles/set_1.module.css'
                                    ...
                                    <Collapse className={styles.menu4} in={open4} timeout="auto" unmountOnExit>
                                        <List component="div" disablePadding>
                                            <ListItemButton className={styles.menu5} sx={{ height: "30px" }}>
                                                ...
                                                <ListItemText sx={{ color: '#3571ff' }} onClick={set_1} primary="회사 정보" />
                                            </ListItemButton>
                                        </List>
                                        <List component="div" disablePadding>
                                            <ListItemButton className={styles.menu5} sx={{ height: "30px" }}>
                        ...
                        <div>
                            ...
                            <div className={styles.box}>
                                <div className={styles.left}>
                                    ...
                                    <div><Button className={styles.upload} variant="contained">사진 추가</Button></div>
                                </div>
