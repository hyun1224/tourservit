...
import styles from '../styles/calc_1.module.css'
                ...
                <div className={styles.body}>
                                    ...
                                    <Collapse className={styles.menu4} in={open3} timeout="auto" unmountOnExit>
                                        <List component="div" disablePadding>
                                            <ListItemButton className={styles.menu5} sx={{ height: "30px" }}>
                                                ...
                                                <ListItemText sx={{ color: '#3571ff' }} onClick={calc_1} primary="입금 목록" />
                                            </ListItemButton>
                                        </List>
                                        <List component="div" disablePadding>
                                            <ListItemButton className={styles.menu5} sx={{ height: "30px" }}>
                    ...
                    <div className={styles.content}>
                        <div>
                            <div className={styles.title}>
                                <h3>입금 목록</h3>
                                <span> <Button className={styles.upload} variant="contained">은행 내역 업로드</Button></span>
                            </div>
                        </div>
                            ...
                            <Table aria-label="simple table">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>입금(원)</TableCell>
                                        <TableCell>취급점</TableCell>
                                ...
                                <TableBody>
                                    <TableRow>
                                        <TableCell>2022년 12월 28일</TableCell>
                                        <TableCell>하동현</TableCell>
                                        <TableCell>250,000 원</TableCell>
                                        <TableCell>신한은행</TableCell>
                                        <TableCell></TableCell>
                                    </TableRow>
                                    <TableRow>
                                        <TableCell>2022년 12월 28일</TableCell>
