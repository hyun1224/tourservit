...
import styles from '../styles/pd_1.module.css'
                ...
                <div className={styles.body}>
                                    ...
                                    <Collapse className={styles.menu4} in={open1} timeout="auto" unmountOnExit>
                                        <List component="div" disablePadding>
                                            <ListItemButton className={styles.menu5} sx={{ height: "30px" }}>
                                                ...
                                                <ListItemText  sx={{ color: '#3571ff' }} onClick={pd_1} primary="상품 목록" />
                                            </ListItemButton>
                                        </List>
                                        <List component="div" disablePadding>
                                            <ListItemButton className={styles.menu5} sx={{ height: "30px" }}>
                    ...
                    <div className={styles.content}>
                        <div>
                            <div className={styles.title}>
                                <h3>상품 목록</h3>
                                <span><div className={styles.search}><Paper
                                    component="form"
                                    sx={{ p: '2px 4px', display: 'flex', alignItems: 'center', width: 400 }}
                                >
                            ...
                            <Table aria-label="simple table">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell>상품수정</TableCell>
                                        <TableCell>상품예약</TableCell>
                                    </TableRow>
                                </TableHead>
                                ...
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell>광안리 바다에서 비치코밍 봉사활동과 선셋 패들보드 봉사 여행1</TableCell>
                                        <TableCell>49,000 원</TableCell>
                                        <TableCell><FormControlLabel sx={{
                                            "&.MuiFormControlLabel-root": { margin: "0" }
                                        }}
                                            control={<IOSSwitch defaultChecked />}
                                            label=""
                                        /></TableCell>
                                        <TableCell><LinkIcon></LinkIcon></TableCell>
                                        <TableCell><AutoFixHighIcon></AutoFixHighIcon></TableCell>
                                        <TableCell><SendIcon></SendIcon></TableCell>
                                    </TableRow>
                                    <TableRow>
                        ...
                        <div className={styles.bottom}>
                            <Button className={styles.add} variant="contained" ><AddIcon></AddIcon><span>상품 추가</span></Button>
